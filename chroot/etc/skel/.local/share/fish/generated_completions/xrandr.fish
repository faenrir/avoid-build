# xrandr
# Autogenerated from man page /usr/share/man/man1/xrandr.1
...
complete -c xrandr -l listmonitors --description 'Report information about all defined monitors.'
complete -c xrandr -l listactivemonitors --description 'Report information about currently active monitors.'
complete -c xrandr -l setmonitor --description 'Define a new monitor with the given geometry and associated to the given outp…'
complete -c xrandr -l delmonitor --description 'Delete the given user-defined monitor.'
...
complete -c xrandr -l filter --description 'Chooses the scaling filter method to be applied when the screen is scaled or …'
...
complete -c xrandr -l fbmm --description 'Sets the value reported as physical size of the X screen as a whole (union of…'
complete -c xrandr -l dpi --description '.'
