# veritysetup
# Autogenerated from man page /usr/share/man/man8/veritysetup.8
...
complete -c veritysetup -l ignore-corruption -l restart-on-corruption -l panic-on-corruption --description 'Defines what to do if data integrity problem is detected (data corruption).'
...
complete -c veritysetup -l root-hash-signature --description 'Path to roothash signature file used to verify the root hash (in kernel).'
